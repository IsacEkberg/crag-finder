...
aws elasticbeanstalk create-application-version --application-name crag-finder-dev --version-label $SHA1 --source-bundle S3Bucket=$EB_BUCKET,S3Key=$DOCKERRUN_FILE
